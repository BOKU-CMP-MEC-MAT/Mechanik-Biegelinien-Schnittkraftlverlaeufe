...
\begin{center}
\begin{tikzpicture}[scale=1.15, rotate=180, >=Stealth, line join=round]
  ...
  \draw[thick] (7.000,0.000) -- (6.780,-0.340) -- (7.220,-0.340) -- cycle;
  \draw[thick] (6.840,-0.460) circle (0.06) (7.160,-0.460) circle (0.06);
  \draw[line width=1.1pt] (6.700,-0.540) -- (7.300,-0.540);
  \fill[pattern=north east lines] (6.700,-0.700) rectangle (7.300,-0.540);
  ...
  \draw[->,red!80!black,line width=1.1pt] (6.000,-1.050) -- (6.000,-2.000);
  \node[red!80!black,above right] at (6.000,-1.450) {$P$};
  ...
  \node[circle,fill=white,draw=gray!60,inner sep=0.7pt,font=\scriptsize] at (5.000,-2.000) {\textbf{3}};
  \node[circle,fill=white,draw=gray!60,inner sep=0.7pt,font=\scriptsize] at (3.500,-1.000) {\textbf{4}};
  \node[circle,fill=white,draw=gray!60,inner sep=0.7pt,font=\scriptsize] at (4.500,-1.000) {\textbf{5}};
  \node[circle,fill=white,draw=gray!60,inner sep=0.7pt,font=\scriptsize] at (5.500,-1.000) {\textbf{6}};
  \node[circle,fill=white,draw=gray!60,inner sep=0.7pt,font=\scriptsize] at (6.500,-1.000) {\textbf{7}};
...
$A_x = 0$\,kN,\quad $A_y = -23$\,kN,\quad $M_A = 42$\,kNm,\quad $B_x = 0$\,kN,\quad $B_y = -15$\,kN\\[2pt]$C_x = 0$\,kN,\quad $C_y = 5$\,kN\par
...
\begin{tikzpicture}[scale=1.15, rotate=180, >=Stealth, line join=round]
  ...
  \node[circle,fill=white,draw=gray!50,inner sep=0.6pt,font=\scriptsize] at (5.000,-2.000) {3};
  \node[circle,fill=white,draw=gray!50,inner sep=0.6pt,font=\scriptsize] at (3.500,-1.000) {4};
  \node[circle,fill=white,draw=gray!50,inner sep=0.6pt,font=\scriptsize] at (4.500,-1.000) {5};
  \node[circle,fill=white,draw=gray!50,inner sep=0.6pt,font=\scriptsize] at (5.500,-1.000) {6};
  \node[circle,fill=white,draw=gray!50,inner sep=0.6pt,font=\scriptsize] at (6.500,-1.000) {7};
  \node[above left=1pt] at (A) {$A$};
  \node[above=4pt] at (C) {$C$};
...
\begin{tikzpicture}[>=Stealth]
  ...
  \node[above,blue!70!black,font=\footnotesize] at (0.000,1.250) {42};
...
\begin{tikzpicture}[>=Stealth]
  ...
  \node[above,red!70!black,font=\footnotesize] at (0.000,1.250) {23};
  \node[below,red!70!black,font=\footnotesize] at (8.000,0.272) {5};
