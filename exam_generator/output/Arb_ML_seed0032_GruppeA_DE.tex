...
\begin{tikzpicture}[scale=0.707,>=Stealth,line join=round]
  ...
  \coordinate (CPIN) at (-0.184,-2.926);
  \draw[thick] (CPIN) -- (TO1);
  \draw[thick] (TO1) -- (TO2);
  \draw[thick] (TU0) -- (TU1);
  \draw[thick] (CPIN) -- (TU0);
  ...
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (-0.842,-2.963) {1};
  ...
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (-0.467,-2.213) {4};
  ...
  \draw[->,red!80!black,line width=1.1pt] (-1.300,-1.500) -- (-2.250,-1.500);
  \node[red!80!black] at (-1.120,-1.500) {$P$};
  ...
  \draw[thin,gray] (0.000,-3.000) -- (0.000,-1.000);
  \draw[thin,gray] (-1.500,-3.000) -- (-1.500,-1.000);
  \draw[<->,gray] (0.000,-1.000) -- (-1.500,-1.000) node[midway,fill=white,inner sep=0.8pt,font=\footnotesize]{$\ell$};
  \draw[thin,gray] (0.000,-3.000) -- (-3.500,-3.000);
  \draw[thin,gray] (0.000,-1.500) -- (-3.500,-1.500);
  \draw[<->,gray] (-3.500,-3.000) -- (-3.500,-1.500) node[midway,fill=white,inner sep=0.8pt,font=\footnotesize]{$h$};
...
$A:\ R_x=14,25,\ R_y=-7,5$\quad $D:\ R_x=9,75,\ R_y=0$\quad $B:\ R_x=0,\ R_y=7,5$\par $C:\ H_x=-15,\ H_y=7,5$
...
\end{tikzpicture}\\[5pt]
\begin{tikzpicture}[scale=0.459,line join=round]
  \filldraw[fill=red!70!black!12,draw=red!70!black,semithick] (-1.300,0.000) -- (-1.266,-0.125) -- (-1.232,-0.250) -- (-1.197,-0.375) -- (-1.163,-0.500) -- (-1.129,-0.625) -- (-1.095,-0.750) -- (-1.061,-0.875) -- (-1.026,-1.000) -- (-0.992,-1.125) -- (-0.958,-1.250) -- (-0.924,-1.375) -- (-0.889,-1.500) -- (-0.855,-1.625) -- (-0.821,-1.750) -- (-0.787,-1.875) -- (-0.753,-2.000) -- (-0.718,-2.125) -- (-0.684,-2.250) -- (-0.650,-2.375) -- (-0.616,-2.500) -- (-0.582,-2.625) -- (-0.547,-2.750) -- (-0.513,-2.875) -- (-0.479,-3.000) -- (0.889,-3.000) -- (0.889,-3.125) -- (0.889,-3.250) -- (0.889,-3.375) -- (0.889,-3.500) -- (0.889,-3.625) -- (0.889,-3.750) -- (0.889,-3.875) -- (0.889,-4.000) -- (0.889,-4.125) -- (0.889,-4.250) -- (0.889,-4.375) -- (0.889,-4.500) -- (0.889,-4.625) -- (0.889,-4.750) -- (0.889,-4.875) -- (0.889,-5.000) -- (0.889,-5.125) -- (0.889,-5.250) -- (0.889,-5.375) -- (0.889,-5.500) -- (0.889,-5.625) -- (0.889,-5.750) -- (0.889,-5.875) -- (0.889,-6.000) -- (0.000,-6.000) -- (0.000,-5.875) -- (0.000,-5.750) -- (0.000,-5.625) -- (0.000,-5.500) -- (0.000,-5.375) -- (0.000,-5.250) -- (0.000,-5.125) -- (0.000,-5.000) -- (0.000,-4.875) -- (0.000,-4.750) -- (0.000,-4.625) -- (0.000,-4.500) -- (0.000,-4.375) -- (0.000,-4.250) -- (0.000,-4.125) -- (0.000,-4.000) -- (0.000,-3.875) -- (0.000,-3.750) -- (0.000,-3.625) -- (0.000,-3.500) -- (0.000,-3.375) -- (0.000,-3.250) -- (0.000,-3.125) -- (0.000,-3.000) -- (0.000,-3.000) -- (0.000,-2.875) -- (0.000,-2.750) -- (0.000,-2.625) -- (0.000,-2.500) -- (0.000,-2.375) -- (0.000,-2.250) -- (0.000,-2.125) -- (0.000,-2.000) -- (0.000,-1.875) -- (0.000,-1.750) -- (0.000,-1.625) -- (0.000,-1.500) -- (0.000,-1.375) -- (0.000,-1.250) -- (0.000,-1.125) -- (0.000,-1.000) -- (0.000,-0.875) -- (0.000,-0.750) -- (0.000,-0.625) -- (0.000,-0.500) -- (0.000,-0.375) -- (0.000,-0.250) -- (0.000,-0.125) -- (0.000,0.000) -- cycle;
  \draw[line width=1.6pt] (0.000,0.000) -- (0.000,-3.000) -- (0.000,-6.000);
  \node[red!70!black,font=\footnotesize,fill=white,inner sep=0.5pt] at (-1.300,0.000) {14,2};
  \node[red!70!black,font=\footnotesize,fill=white,inner sep=0.5pt] at (0.889,-3.000) {-9,8};
  \fill (0.000,0.000) circle (1.3pt);
  \node[font=\footnotesize] at (0.000,0.000) [xshift=-6pt,yshift=6pt] {$A$};
  \fill (0.000,-3.000) circle (1.3pt);
  \node[font=\footnotesize] at (0.000,-3.000) [xshift=-6pt,yshift=6pt] {$C$};
  \fill (0.000,-6.000) circle (1.3pt);
  \node[font=\footnotesize] at (0.000,-6.000) [xshift=-6pt,yshift=6pt] {$D$};
  \node[red!70!black,right] at (1.24,0.20) {$V(s)$};
\end{tikzpicture}\\[5pt]
\begin{tikzpicture}[scale=0.459,line join=round]
  ...
  \draw[line width=1.6pt] (0.000,0.000) -- (0.000,-3.000) -- (0.000,-6.000);
  \node[green!45!black,font=\footnotesize,fill=white,inner sep=0.5pt] at (1.300,0.000) {-7,5};
  \fill (0.000,0.000) circle (1.3pt);
  \node[font=\footnotesize] at (0.000,0.000) [xshift=-6pt,yshift=6pt] {$A$};
  \fill (0.000,-3.000) circle (1.3pt);
  \node[font=\footnotesize] at (0.000,-3.000) [xshift=-6pt,yshift=6pt] {$C$};
