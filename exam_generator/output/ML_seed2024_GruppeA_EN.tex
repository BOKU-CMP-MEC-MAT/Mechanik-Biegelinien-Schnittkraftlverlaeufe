...
\begin{center}
  ...
  {\normalsize \textbf{System values:} $L = 2$\,m,\quad $q = 3$\,kN/m,\quad $P = 20$\,kN}
\end{center}
...
\cmidrule(lr){2-4}\cmidrule(lr){5-7}
 ...
 & $M$\,[kNm] & $V$\,[kN] & $N$\,[kN] \\
\midrule
Beam~[1] (A$\to$C) & $-44.00$ & $22.00$ & $20.00$ & $-6.00$ & $16.00$ & $20.00$ \\[3pt]
Beam~[2] (C$\to$G) & $-6.00$ & $6.00$ & $0.00$ & $-0.00$ & $0.00$ & $0.00$ \\
\bottomrule
\end{tabular}
\end{center}
