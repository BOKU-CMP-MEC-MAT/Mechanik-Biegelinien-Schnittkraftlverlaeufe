...
\begin{center}
  ...
  {\normalsize \textbf{Systemwerte:} $L = 1$\,m,\quad $q = 6$\,kN/m,\quad $P = 8$\,kN}
\end{center}
...
\cmidrule(lr){2-4}\cmidrule(lr){5-7}
 ...
 & $M$\,[kNm] & $V$\,[kN] & $N$\,[kN] \\
\midrule
Stab~[1] (A$\to$C) & $-16.00$ & $16.00$ & $8.00$ & $-3.00$ & $10.00$ & $8.00$ \\[3pt]
Stab~[2] (C$\to$G) & $-3.00$ & $6.00$ & $0.00$ & $-0.00$ & $0.00$ & $0.00$ \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{align*}
  \sum F_y = 0:\quad & \tfrac{S_8}{\sqrt{2}} + B_V = 0
    &&\Rightarrow\quad S_8 = -\sqrt{2}\,B_V = \tfrac{P}{\sqrt{2}}
       &&\Rightarrow\quad \boxed{S_8 = \tfrac{P}{\sqrt{2}} \approx 5.66\,\text{kN (Zug)}} \\
  \sum F_x = 0:\quad & -\tfrac{S_8}{\sqrt{2}} - S_9 = 0
    &&\Rightarrow\quad S_9 = -\tfrac{S_8}{\sqrt{2}} = -\tfrac{P}{2}
       &&\Rightarrow\quad \boxed{S_9 = -\tfrac{P}{2} = -4.00\,\text{kN (Druck)}}
\end{align*}
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_5 = -\tfrac{P}{2} = -4.00\,\text{kN (Druck)}}
\]
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_4 = \sqrt{2}\,P = 11.31\,\text{kN (Zug)}}
\]
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_6 = -\tfrac{P}{\sqrt{2}} = -5.66\,\text{kN (Druck)}}
\]
...
$B_V = \tfrac{1}{3}q_0 L = 1.33$\,kN, und
\[
  M(x) = -\tfrac{q_0}{6L}\,x^3 + \tfrac{q_0 L}{6}\,x.
\]

\textbf{Systemwerte:} $L = 1$\,m,\quad $q_0 = 4$\,kN/m.
