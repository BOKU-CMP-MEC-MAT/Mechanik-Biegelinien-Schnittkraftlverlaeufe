...
\begin{tikzpicture}[scale=0.855,>=Stealth,line join=round]
  ...
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (1.000,-3.000) {1};
  ...
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (0.500,-4.000) {4};
