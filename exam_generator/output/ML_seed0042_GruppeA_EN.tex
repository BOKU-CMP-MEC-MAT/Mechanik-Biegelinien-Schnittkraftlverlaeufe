...
\begin{center}
  ...
  {\normalsize \textbf{System values:} $L = 0.5$\,m,\quad $q = 2$\,kN/m,\quad $P = 20$\,kN}
\end{center}
...
\cmidrule(lr){2-4}\cmidrule(lr){5-7}
 ...
 & $M$\,[kNm] & $V$\,[kN] & $N$\,[kN] \\
\midrule
Beam~[1] (A$\to$C) & $-6.00$ & $12.00$ & $20.00$ & $-0.25$ & $11.00$ & $20.00$ \\[3pt]
Beam~[2] (C$\to$G) & $-0.25$ & $1.00$ & $0.00$ & $-0.00$ & $0.00$ & $0.00$ \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{align*}
  \sum F_y = 0:\quad & \tfrac{S_8}{\sqrt{2}} + B_V = 0
    &&\Rightarrow\quad \boxed{S_8 = \tfrac{P}{\sqrt{2}} \approx 14.14\,\text{kN (tension)}} \\
  \sum F_x = 0:\quad & -\tfrac{S_8}{\sqrt{2}} - S_9 = 0
    &&\Rightarrow\quad \boxed{S_9 = -\tfrac{P}{2} = -10.00\,\text{kN (compression)}}
\end{align*}
...
$B_V = \tfrac{1}{3}q_0 L = 0.67$\,kN, and
\[
  M(x) = -\tfrac{q_0}{6L}\,x^3 + \tfrac{q_0 L}{6}\,x.
\]
\textbf{Values:} $L = 0.5$\,m,\quad $q_0 = 4$\,kN/m.
