...
\begin{center}
  ...
  {\normalsize \textbf{System values:} $L = 1.5$\,m,\quad $q = 3$\,kN/m,\quad $P = 15$\,kN}
\end{center}
...
$A_V$ & $A_H$ & $M_A$ & $B_V$ \\
\midrule
$2qL + \tfrac{P}{2} = \mathbf{16.50}$\,kN
& $-P = \mathbf{-15.00}$\,kN
& $2qL^2 + \tfrac{PL}{2} = \mathbf{24.75}$\,kNm
& $-\tfrac{P}{2} = \mathbf{-7.50}$\,kN \\
\bottomrule
\end{tabular}
\end{center}
...
\cmidrule(lr){2-4}\cmidrule(lr){5-7}
 ...
 & $M$\,[kNm] & $V$\,[kN] & $N$\,[kN] \\
\midrule
Beam~[1] (A$\to$C) & $-24.75$ & $16.50$ & $15.00$ & $-3.38$ & $12.00$ & $15.00$ \\[3pt]
Beam~[2] (C$\to$G) & $-3.38$ & $4.50$ & $0.00$ & $-0.00$ & $0.00$ & $0.00$ \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tikzpicture}[xscale=3.2, yscale=3.2, >=stealth, thick, font=\small]
  ...
  \begin{scope}[yshift=-2.8cm]
    ...
    % Labels
    \node[right, red!70!black] at (0,  0.7000) {$V=16.5$\,kN};
    \node[right, red!70!black] at (1,  0.5091) {$V=12.0$\,kN};
    \node[left,  red!70!black] at (1,  0.1909) {$V=4.5$\,kN};
...
\begin{align*}
  \sum F_y = 0:\quad & \tfrac{S_8}{\sqrt{2}} + B_V = 0
    &&\Rightarrow\quad \boxed{S_8 = \tfrac{P}{\sqrt{2}} \approx 10.61\,\text{kN (tension)}} \\
  \sum F_x = 0:\quad & -\tfrac{S_8}{\sqrt{2}} - S_9 = 0
    &&\Rightarrow\quad \boxed{S_9 = -\tfrac{P}{2} = -7.50\,\text{kN (compression)}}
\end{align*}
...
$S_8$ & $S_9$ & $S_4$ & $S_5$ & $S_6$ \\
\midrule
$\tfrac{P}{\sqrt{2}} = 10.61$ & $-\tfrac{P}{2} = -7.50$ &
$\sqrt{2}\,P = 21.21$ & $-\tfrac{P}{2} = -7.50$ & $-\tfrac{P}{\sqrt{2}} = -10.61$ \\
...
\]
\textbf{Values:} $L = 1.5$\,m,\quad $q_0 = 8$\,kN/m.
...
\[
  \frac{q_0 L}{6} = \frac{q_0}{2L}\,x^2
  \;\Rightarrow\; \boxed{x_{\max} = \frac{L}{\sqrt{3}} \approx 0.8660\,\text{m}}
\]
...
\[
  \boxed{M_{\max} = \frac{q_0 L^2}{9\sqrt{3}}
       = \frac{\sqrt{3}}{27}\,q_0 L^2 \approx 1.1547\,\text{kNm}}
\]
