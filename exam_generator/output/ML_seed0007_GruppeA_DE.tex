...
\begin{center}
  ...
  {\normalsize \textbf{Systemwerte:} $L = 1.5$\,m,\quad $q = 3$\,kN/m,\quad $P = 15$\,kN}
\end{center}
...
\cmidrule(lr){2-4}\cmidrule(lr){5-7}
 ...
 & $M$\,[kNm] & $V$\,[kN] & $N$\,[kN] \\
\midrule
Stab~[1] (A$\to$C) & $-24.75$ & $16.50$ & $15.00$ & $-3.38$ & $12.00$ & $15.00$ \\[3pt]
Stab~[2] (C$\to$G) & $-3.38$ & $4.50$ & $0.00$ & $-0.00$ & $0.00$ & $0.00$ \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{align*}
  \sum F_y = 0:\quad & \tfrac{S_8}{\sqrt{2}} + B_V = 0
    &&\Rightarrow\quad S_8 = -\sqrt{2}\,B_V = \tfrac{P}{\sqrt{2}}
       &&\Rightarrow\quad \boxed{S_8 = \tfrac{P}{\sqrt{2}} \approx 10.61\,\text{kN (Zug)}} \\
  \sum F_x = 0:\quad & -\tfrac{S_8}{\sqrt{2}} - S_9 = 0
    &&\Rightarrow\quad S_9 = -\tfrac{S_8}{\sqrt{2}} = -\tfrac{P}{2}
       &&\Rightarrow\quad \boxed{S_9 = -\tfrac{P}{2} = -7.50\,\text{kN (Druck)}}
\end{align*}
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_5 = -\tfrac{P}{2} = -7.50\,\text{kN (Druck)}}
\]
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_4 = \sqrt{2}\,P = 21.21\,\text{kN (Zug)}}
\]
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_6 = -\tfrac{P}{\sqrt{2}} = -10.61\,\text{kN (Druck)}}
\]
...
\textbf{Systemwerte:} $L = 1.5$\,m,\quad $q_0 = 8$\,kN/m.
