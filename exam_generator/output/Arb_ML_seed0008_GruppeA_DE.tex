...
\begin{tikzpicture}[scale=1.250,>=Stealth,line join=round]
  ...
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (4.375,-0.750) {1};
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (3.625,-0.750) {2};
