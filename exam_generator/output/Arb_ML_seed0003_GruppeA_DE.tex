...
\begin{tikzpicture}[scale=1.250,>=Stealth,line join=round]
  ...
  \coordinate (CPIN) at (3.042,0.104);
  \draw[thick] (CPIN) -- (TO1);
  \draw[thick] (TO1) -- (TO2);
  \draw[thick] (TU0) -- (TU1);
  \draw[thick] (CPIN) -- (TU0);
  ...
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (3.021,0.802) {1};
  ...
  \node[circle,fill=white,draw=gray!55,inner sep=0.5pt,font=\scriptsize] at (3.771,0.427) {4};
