...
\midrule
  1 (C\,--\,O1) & 4.5 & tension \\
  2 (O1\,--\,O2) & -2.5 & compression \\
  3 (U0\,--\,U1) & 7 & tension \\
  4 (C\,--\,U0) & 7.83 & tension \\
  5 (U0\,--\,O1) & -7.83 & compression \\
  6 (O1\,--\,U1) & 7.83 & tension \\
  7 (U1\,--\,O2) & 5.59 & tension \\
\bottomrule
...
\begin{tikzpicture}[scale=1.15, rotate=90, >=Stealth, line join=round]
  ...
  \node[font=\footnotesize,align=center] at (2.00,2.80) {red: tension $(+)$ \quad blue: compression $(-)$};
\end{tikzpicture}
\end{center}
