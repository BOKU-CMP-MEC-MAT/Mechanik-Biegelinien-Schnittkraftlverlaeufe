...
\begin{center}
  ...
  {\normalsize \textbf{Systemwerte:} $L = 2$\,m,\quad $q = 5$\,kN/m,\quad $P = 10$\,kN}
\end{center}
...
\cmidrule(lr){2-4}\cmidrule(lr){5-7}
 ...
 & $M$\,[kNm] & $V$\,[kN] & $N$\,[kN] \\
\midrule
Stab~[1] (A$\to$C) & $-50.00$ & $25.00$ & $10.00$ & $-10.00$ & $15.00$ & $10.00$ \\[3pt]
Stab~[2] (C$\to$G) & $-10.00$ & $10.00$ & $0.00$ & $-0.00$ & $0.00$ & $0.00$ \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{align*}
  \sum F_y = 0:\quad & \tfrac{S_8}{\sqrt{2}} + B_V = 0
    &&\Rightarrow\quad S_8 = -\sqrt{2}\,B_V = \tfrac{P}{\sqrt{2}}
       &&\Rightarrow\quad \boxed{S_8 = \tfrac{P}{\sqrt{2}} \approx 7.07\,\text{kN (Zug)}} \\
  \sum F_x = 0:\quad & -\tfrac{S_8}{\sqrt{2}} - S_9 = 0
    &&\Rightarrow\quad S_9 = -\tfrac{S_8}{\sqrt{2}} = -\tfrac{P}{2}
       &&\Rightarrow\quad \boxed{S_9 = -\tfrac{P}{2} = -5.00\,\text{kN (Druck)}}
\end{align*}
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_5 = -\tfrac{P}{2} = -5.00\,\text{kN (Druck)}}
\]
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_4 = \sqrt{2}\,P = 14.14\,\text{kN (Zug)}}
\]
...
\[
  ...
  \quad\Rightarrow\quad \boxed{S_6 = -\tfrac{P}{\sqrt{2}} = -7.07\,\text{kN (Druck)}}
\]
